...
##plot 3
png("./plot3.png",unit="px", width=480, height=480, type="windows")
...
legend("topright", c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),lty="solid", col=c("black","red","blue"),cex=0.75)
